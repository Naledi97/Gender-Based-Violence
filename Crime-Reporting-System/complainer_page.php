  ...
  <div class="container">
    ...
    <div id="navbar" class="collapse navbar-collapse">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="active"><a href="complainer_page.php">Log New Report</a></li>
	...
	<div class="center-container">
		 <div class="bg-agile">
			...
			<div class="login-form"><p><h2 style="color:white">Welcome <?php echo "$u_name" ?></h2></p><br>
                                    <p><h2>Log New Report</h2></p><br>	
				<form action="#" method="post" style="color: gray">
					
				<div class="top-w3-agile" style="color: gray">Location of Offence
                    
                    <select id="others" class="form-control" name="location" required>
               <option value="">--Please select a police station--</option>
						<?php
				...
				<div class="top-w3-agile" style="color: gray">Type of Offence
					<select class="form-control" name="type_crime" required>
                  <option value="">--Please select offence type--</option>
					...
					<div class="top-w3-agile" style="color: gray">
					Description
						<textarea  name="description" rows="20" cols="50" placeholder="Please issnclude as much details as possible e.g street address" onfocusout="f1()" id="desc" required></textarea>
					</div>
...
<div style="position: relative;
   ...
   color: white;
   text-align: center;">
  <h4 style="color: white;">&copy <b>Namibia GBV Portal 2021</b></h4>
</div>
