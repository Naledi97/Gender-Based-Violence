...
<script>
     function f1()
        {
            ...
            var sta1=document.getElementById("id_number1").value;
  ...
  var x4=sta4.indexOf(' ');
    ...
    document.getElementById("id_number1").value="";
    document.getElementById("id_number1").focus();
      alert("Space Not Allowed");
        }
        else if(sta2!="" && x2>=0){
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="home.php"><b>GBV Portal</b></a>
    </div>
		 ...
		 <div class="bg-agile">
			...
			<div class="login-form">	
				<form action="#" method="post">
					...
					<p style="color:#dfdfdf">ID Number/Passport Number</p><input type="text"  name="id_number"  required="" id="id_number1" onfocusout="f1()"/>
					...
					<!--<p style="color:#dfdfdf">Case ID Number</p><input type="text"  name="aadhar_number" minlength="12" maxlength="12" required pattern="[123456789][0-9]{11}" id="aadh" onfocusout="f1()"/>-->
					<div class="left-w3-agile">
						<p style="color:#dfdfdf">Gender</p><select class="form-control" name="gender" required>
              <option value="">--Please select the gender--</option>
					...
					<div class="right-agileits">
						<p style="color:#dfdfdf">Mobile</p><input type="text"  name="mobile_number" required pattern="^\d{10}$" minlength="10" maxlength="13" id="mobno" onfocusout="f1()"/>
					</div>
