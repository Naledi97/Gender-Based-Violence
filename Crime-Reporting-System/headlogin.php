...
<body style="color: black;background-image: url(NewHQ.jpg);background-size: 100%;background-repeat: no-repeat;back">
 ...
 <div  align="center" >
  ...
  <div class="form-group" style="width: 30%">
    <label for="exampleInputEmail1"  ><h1 style="color:white">Police Administration ID</h1></label>
