...
<body style="background-size: cover;
  ...
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="home.php" style="margin-top: 5%;"><b>GBV Portal</b></a>
    </div>
 ...
 <div  align="center" >
  ...
  <div class="form-group" style="width: 30%">
    ...
    <input type="Number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" size="5" placeholder="Enter ID Number/Passport Number

" required name="id_number" onfocusout="f1()">
     </div>
  <div class="form-group" style="width:30%">
